"""
Django settings for zoho_book_report project.
...
SECRET_KEY = 'django-insecure-%(4z8xf+wgw1e#zekc7$nrcq4z=@z(oi08z3d8h*2r^+0mes=%'
...
ROOT_URLCONF = 'zoho_book_report.urls'
...
WSGI_APPLICATION = 'zoho_book_report.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file':os.path.join(SUPER_BASE, 'conf', 'zoho_book_report', 'db', 'mysql.conf')
        }
    }
}
